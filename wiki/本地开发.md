...
使用 Docker Compose 启动 TiDB 和 Redis：
...
- 项目测试覆盖率最低要求统一为 `>=90%`（auth9-core、auth9-portal、SDK）。
- 覆盖率目标以 `docs/testing/implementation-summary.md` 和 `docs/security/README.md` 为准。
