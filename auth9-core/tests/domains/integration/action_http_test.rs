...
async fn setup_tenant_and_service(state: &TestAppState, tenant_id: Uuid) -> Uuid {
    ...
    let client = auth9_core::models::service::Client {
...
async fn test_cross_service_access_returns_403() {
    ...
    let client_b = auth9_core::models::service::Client {
        id: auth9_core::models::common::StringUuid::new_v4(),
        service_id: auth9_core::models::common::StringUuid::from(service_b_id),
