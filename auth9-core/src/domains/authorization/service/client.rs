    ...
    > ClientService<R, RR, AR, BR>
{
    ...
    pub async fn verify_secret(&self, client_id: &str, secret: &str) -> Result<Service> {
        ...
        if service.status != crate::models::service::ServiceStatus::Active {
...
mod tests {
    ...
    async fn test_create_service_duplicate_client_id() {
        ...
        mock.expect_find_client_by_client_id()
            ...
            .returning(|_| {
                Ok(Some(crate::models::service::Client {
    ...
    async fn test_list_clients() {
        ...
        mock.expect_list_clients()
            .with(eq(service_id))
            .returning(|_| {
                Ok(vec![crate::models::service::Client {
                    id: StringUuid::new_v4(),
                    service_id: StringUuid::new_v4(),
        ...
        mock.expect_update().returning(|_, input| {
            Ok(Service {
                ...
                status: input
                    .status
                    .clone()
                    .unwrap_or(crate::models::service::ServiceStatus::Active),
                ..Default::default()
            })
        });
    ...
    async fn test_verify_secret_inactive_service() {
        ...
        mock.expect_find_by_id().returning(move |_| {
            Ok(Some(Service {
                id: StringUuid(service_id),
                status: crate::models::service::ServiceStatus::Inactive, // Inactive service
                ..Default::default()
            }))
        });
