        ...
        entries: [
            {
                ...
                rolePermissionCounts: { r1: 2, r2: 0 } as Record<string, number>,
            },
            {
                service: mockServices.data[1],
                roles: [],
                permissions: [],
                rolePermissionCounts: {} as Record<string, number>,
            },
        ],
                ...
                entries: [
                    {
                        ...
                        roles: mockRoles,
                        permissions: [],
                        rolePermissionCounts: { r1: 0, r2: 0 } as Record<string, number>,
                    },
                ],
                pagination: mockServices.pagination,
            };
                ...
                entries: [
                    {
                        ...
                        permissions: [],
                        rolePermissionCounts: { r1: 0, r3: 0 } as Record<string, number>,
                    },
                ],
