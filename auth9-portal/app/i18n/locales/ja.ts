export default {
  ...
  dashboard: {
    ...
    nav: { overview: "概要", tenants: "テナント", users: "ユーザー", services: "サービス", roles: "ロール", abac: "ABACポリシー", analytics: "分析", security: "セキュリティ", securityRisk: "リスク概要", auditLogs: "監査ログ", settings: "設定", main: "メイン", securityGroup: "セキュリティ", system: "システム" },
    userFallback: "ユーザー",
  },
  account: {
  ...
  tenants: {
    ...
    sso: { metaTitle: "Enterprise SSO - {{tenantName}} - Auth9", title: "{{tenantName}}のEnterprise SSO", description: "テナントスコープのEnterprise SAML/OIDCコネクタを設定します。", createTitle: "コネクタを作成", createDescription: "カンマ区切りのドメインを使用します。SAMLの場合は、Entity ID、SSO URL、証明書を指定してください。", alias: "エイリアス", aliasPlaceholder: "corp-saml", displayName: "表示名", displayNamePlaceholder: "Acme SSO", providerType: "プロバイダータイプ", priority: "優先度", domains: "ドメイン", domainsPlaceholder: "acme.com, acme.org", samlEntityId: "SAML Entity ID", samlEntityIdPlaceholder: "https://idp.acme.com/entity", samlSsoUrl: "SAML SSO URL", samlSsoUrlPlaceholder: "https://idp.acme.com/sso", samlCertificate: "SAML署名証明書", samlCertificatePlaceholder: "-----BEGIN CERTIFICATE-----...", oidcClientId: "OIDC Client ID", oidcClientSecret: "OIDC Client Secret", oidcAuthorizationUrl: "OIDC Authorization URL", oidcTokenUrl: "OIDC Token URL", oidcUserInfoUrl: "OIDC UserInfo URL", ldapServerUrl: "Server URL", ldapServerUrlPlaceholder: "ldaps://ldap.example.com:636", ldapBindDn: "Bind DN", ldapBindDnPlaceholder: "cn=auth9,ou=services,dc=example,dc=com", ldapBindPassword: "Bind Password", ldapBaseDn: "Base DN", ldapBaseDnPlaceholder: "ou=users,dc=example,dc=com", ldapUserSearchFilter: "User Search Filter", ldapAttrUsername: "Username Attribute", ldapAttrEmail: "Email Attribute", ldapAttrFirstName: "First Name Attribute", ldapAttrLastName: "Last Name Attribute", ldapIsActiveDirectory: "Active Directory", ldapAdDomain: "AD Domain (for UPN login)", ldapGroupMappings: "Group Mappings", ldapGroupMappingsTitle: "LDAP Group-Role Mappings", ldapGroupMappingsDescription: "Map LDAP groups to Auth9 roles. Roles are synced on each user login.", ldapAddMapping: "Add Mapping", ldapGroupDn: "LDAP Group DN", ldapGroupDisplayName: "Display Name", ldapRoleId: "Role ID", ldapNoMappings: "No group mappings configured.", ldapMappingCreated: "Group mapping created.", ldapMappingDeleted: "Group mapping deleted.", ldapLoginButton: "Sign in with LDAP", ldapUsernamePlaceholder: "Username", createConnector: "コネクタを作成", configuredTitle: "設定済みコネクタ", configuredDescription: "テナントルーティングコネクタの利用可否と検証を管理します。", noConnectors: "Enterpriseコネクタが設定されていません。", connectorCreated: "コネクタを作成しました", connectorDeleted: "コネクタを削除しました", connectorUpdated: "コネクタを更新しました", editDomains: "ドメインを編集", domainsValidationError: "有効なドメインを1つ以上入力してください（例: example.com）" }, // pragma: allowlist secret
  ...
  riskPolicy: {
    title: "リスクポリシー",
    mfaThreshold: "MFA昇格閾値",
    blockThreshold: "ブロック閾値",
    notifyAdmin: "高リスク時に管理者へ通知",
    autoLockAccount: "重大リスク時にアカウントを自動ロック",
    saveSuccess: "リスクポリシーを更新しました",
    saveFailed: "リスクポリシーの更新に失敗しました",
    description: "自動リスク応答の閾値を設定",
  },
  adaptiveMfa: {
    title: "アダプティブMFA",
    description: "多要素認証ポリシーと動作を設定",
    mode: "MFAモード",
    modeDisabled: "無効",
    modeAlways: "常に要求",
    modeAdaptive: "リスクベース",
    modeOptional: "オプション登録",
    riskThreshold: "リスク閾値",
    trustDeviceDays: "デバイス信頼日数",
    alwaysRequireAdmins: "管理者には常にMFAを要求",
    saveSuccess: "MFAポリシーを更新しました",
    saveFailed: "MFAポリシーの更新に失敗しました",
  },
  trustedDevices: {
    title: "信頼済みデバイス",
    description: "MFA信頼済みとしてマークされたデバイス",
    noDevices: "信頼済みデバイスはありません",
    revoke: "取り消し",
    revokeAll: "すべて取り消し",
    revokeSuccess: "デバイスの信頼を取り消しました",
    trustDevice: "このデバイスを{{days}}日間信頼する",
    trustedAt: "信頼日時",
    expiresAt: "有効期限",
    lastUsed: "最終使用",
  },
  securityRisk: {
    title: "リスク概要",
    metaTitle: "セキュリティリスク概要 - Auth9",
    riskLevels: "リスクレベル",
    lowRisk: "低 (0-25): ログイン許可",
    mediumRisk: "中 (26-50): 許可して警告",
    highRisk: "高 (51-75): MFA要求",
    criticalRisk: "重大 (76-100): ログインブロック",
    currentPolicy: "現在のポリシー",
    viewAlerts: "セキュリティアラートを表示",
    configurePolicy: "リスクポリシーを設定",
  },
  rolesPage: {
    ...
    hierarchyCardTitle: "ロール階層", hierarchyCardDescription: "各サービスのロール継承構造を表示", noRolesDefined: "このサービスにはロールが定義されていません", orphanedRoles: "孤立ロール（無効な親）:", permissionCount: "{{count}}権限", permissionCount_one: "{{count}}権限", permissionCount_other: "{{count}}権限",
  ...
  usersPage: {
    ...
    name: "名前", mfa: "MFA", updated: "更新日", enabled: "有効", disabled: "無効", manageTenants: "テナントを管理", edit: "編集", noUsersFound: "ユーザーが見つかりません", emptyTitle: "ユーザーがまだいません", emptyDescription: "最初のユーザーを作成してID管理を始めましょう。", clearFilter: "フィルターをクリア", email: "メール", displayName: "表示名", openMenu: "メニューを開く", actions: "アクション",
