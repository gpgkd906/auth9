...
**场景数**: 5
**风险等级**: 🟠 高
**ASVS 5.0 矩阵ID**: M-INPUT-02
**OWASP ASVS 5.0**: V1.2,V3.1,V3.2
...
### 执行清单
- [ ] M-INPUT-02-C01 | 控制: V1.2 | 任务: #13, #20 | 动作: 执行文档内相关攻击步骤并记录证据
- [ ] M-INPUT-02-C02 | 控制: V3.1 | 任务: #13, #20 | 动作: 执行文档内相关攻击步骤并记录证据
- [ ] M-INPUT-02-C03 | 控制: V3.2 | 任务: #13, #20 | 动作: 执行文档内相关攻击步骤并记录证据
