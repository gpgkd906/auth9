...
|---|------|------|----------|----------|----------|
| 1 | 暴力破解检测阈值边界测试 | ✅ PASS | 2026-03-03 | opencode | |
| 2 | 低速攻击规避 | ✅ PASS (已知限制) | 2026-03-03 | opencode | 缺少24小时时间窗口检测，低速攻击可绕过 |
| 3 | 分布式攻击规避 | ✅ PASS | 2026-03-03 | opencode | |
| 4 | 不可能旅行检测准确性 | ⚠️ PARTIAL | 2026-03-03 | opencode | GeoIP未完全实现，位置显示IP地址而非真实地理位置 |
