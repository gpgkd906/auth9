...
**场景数**: 2
**风险等级**: 🟠 高
**ASVS 5.0 矩阵ID**: M-ADV-06
**OWASP ASVS 5.0**: V4.3,V12.2,V13.3
**回归任务映射**: Backlog #20
...
|---|------|------|----------|----------|----------|
| 1 | CL-TE / TE-CL 走私攻击 | ✅ PASS | 2026-02-22 | Sisyphus | 无 |
| 2 | HTTP/2 降级攻击 | ✅ PASS | 2026-02-22 | Sisyphus | 无 |
...
**矩阵ID**: M-ADV-06  
**适用控制**: V4.3,V12.2,V13.3  
**关联任务**: Backlog #20  
**建议回归频率**: 每次发布前 + 缺陷修复后必跑  
**场景总数**: 2

### 执行清单
- [x] M-ADV-06-C01 | 控制: V4.3 | 任务: #20 | 动作: 执行文档内相关攻击步骤并记录证据
- [x] M-ADV-06-C02 | 控制: V12.2 | 任务: #20 | 动作: 执行文档内相关攻击步骤并记录证据
- [x] M-ADV-06-C03 | 控制: V13.3 | 任务: #20 | 动作: 执行文档内相关攻击步骤并记录证据

### 回归记录表
| 检查项ID | 执行结果(pass/fail) | 风险等级 | 证据（请求/响应/日志/截图） | 备注 |
|---|---|---|---|---|
| M-ADV-06-C01 | pass | 高 | CL-TE: 415, TE-CL: 415, Double CL: 400, Obfuscated TE: 400 | RFC 7230 合规 |
| M-ADV-06-C02 | pass | 高 | HTTP/2 TE: 422, Path traversal: 404, Long headers: 401 | 降级安全 |
| M-ADV-06-C03 | pass | 高 | Header规范化: 正常处理, HPACK: 正常处理 | HTTP/2 合规 |
