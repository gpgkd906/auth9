---
name: ops
description: Operations skill for Auth9 project. Run tests (Rust cargo test, TypeScript vitest/playwright), fetch service logs from Docker containers or Kubernetes pods. Use when the user asks to run tests, check logs, debug services, or troubleshoot issues.
---
